...
def setup(lvl):
    ...
    if lvl == 1:
        map = [
            list("RRYYBBPP"),
            list("RRYYOBB/"), #  Bubble cannot be located on /
            list("GGPPOOBB"),
            list("YYGGPPO/"), 
...
def prepare_bubbles():
    ...
    if next_bubble:
        ...
        curr_bubble = create_bubble() # Create New Bubble

    curr_bubble.set_rect((screen_width // 2, 650))
    next_bubble = create_bubble()
    next_bubble.set_rect((screen_width // 4, 714))
...
background = pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "background.png"))

# Importing wall image
wall = pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "wall.png"))

# Importing bubble images
bubble_images = [
    pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "red.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "orange.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "yellow.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "green.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "blue.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "purple.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "black.png")).convert_alpha()
]

# Importing pointer image
pointer_image = pygame.image.load(os.path.join(current_path, "Progress_And_Pictures", "pointer.png"))
